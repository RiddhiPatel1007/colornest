...
// wrapper.setAttribute("data-colors", colorNameList.join(",").toLowerCase());
...
//     wrapper.appendChild(palette); // Palette
//     wrapper.appendChild(like);    // Heart below palette
...
//         localStorage.setItem(
//          "generatedPalettes",
//             JSON.stringify(generatedPalettes)
//         );
// } 
    // 2. FILTER FUNCTION 
   function createPalettes(count = 15){ 
